            ...
            <CardHeader className="pb-3">
              ...
              <Tabs defaultValue="all" onValueChange={setSelectedTab}>
                <TabsList className="grid w-full grid-cols-5">
                  ...
                  <TabsTrigger value="unread" className="dark:data-[state=active]:bg-gray-700 dark:text-gray-300">
                    Unread
                  </TabsTrigger>
                  <TabsTrigger value="order" className="dark:data-[state=active]:bg-gray-700 dark:text-gray-300">
                    Orders
                  </TabsTrigger>
                  <TabsTrigger value="payment" className="dark:data-[state=active]:bg-gray-700 dark:text-gray-300">
                    Payments
                  </TabsTrigger>
                  <TabsTrigger value="system" className="dark:data-[state=active]:bg-gray-700 dark:text-gray-300">
                    System
                  </TabsTrigger>
                </TabsList>
              </Tabs>
                ...
                <div className="flex items-center justify-between p-4 border-b dark:border-gray-700">
                  ...
                  <Select defaultValue="newest">
                    ...
                    <SelectContent className="dark:bg-gray-800 dark:border-gray-700">
                      ...
                      <SelectItem value="oldest" className="dark:text-gray-300">
                        Oldest First
                      </SelectItem>
                      <SelectItem value="unread" className="dark:text-gray-300">
                        Unread First
                      </SelectItem>
                    </SelectContent>
                  </Select>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <Badge className="bg-purple-500">Push</Badge>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <Badge className="bg-purple-500">SMS</Badge>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <Label htmlFor="digest-frequency" className="text-sm dark:text-gray-300">
                      Frequency
                    </Label>
